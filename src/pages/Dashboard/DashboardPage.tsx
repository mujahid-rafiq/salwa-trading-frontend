        ...
        <div className="rounded-2xl border border-gray-800 bg-[#0f1724] p-3 md:p-6">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
              ...
              <button
                className="cursor-pointer rounded-lg bg-gradient-to-r from-[#D4AF37] to-[#B8860B] px-4 py-2 text-xs font-semibold text-black transition hover:brightness-110 sm:text-sm sm:px-5 sm:py-2.5"
