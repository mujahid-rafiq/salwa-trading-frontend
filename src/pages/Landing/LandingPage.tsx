      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#0b0b0b]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10">
          <Link to={ROUTES.HOME} className="flex items-center gap-2 hover:opacity-80 transition">
            ...
            <span className="font-display text-xl font-semibold tracking-wide text-[#f4d678]">Noovacor</span>
          </Link>
      ...
      <section className="relative flex min-h-[760px] items-center overflow-hidden px-6 pb-20 pt-36 lg:px-10">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.05fr_.95fr]">
          <div>
            ...
            <p className="mt-7 max-w-xl text-lg leading-8 text-white/60">Noovacor gives you a straightforward way to explore opportunities, track your progress, and make more informed decisions about your capital.</p>
